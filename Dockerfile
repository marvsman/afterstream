...
ENV VITE_USE_TRAKT=${USE_TRAKT}
ENV VITE_TRAKT_CLIENT_ID=${TRAKT_CLIENT_ID}
ENV VITE_TRAKT_CLIENT_SECRET=${TRAKT_CLIENT_SECRET}
ENV VITE_TRAKT_REDIRECT_URI=${TRAKT_REDIRECT_URI}
